...
public class MainActivity111111 extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
    private static final String TAG = "moubiao";
    public static MainActivity111111 instance;
...
//                   Bitmap originBitmap = BitmapFactory.decodeByteArray(mPreviewData, 0, mPreviewData.length);
                        if (focus = true) {
//                            focus = false;
                            Bitmap cropBitmap = previewSFV.getPreviewPicture(mPreviewData);
    ...
    private void initView() {
        ...
        mHolder.addCallback(MainActivity111111.this);
...
//            mCamera.cancelAutoFocus();//聚焦
    ...
    public void startFocusTimmer() {
        ...
        preHandler.sendEmptyMessageDelayed(2, 10000);
