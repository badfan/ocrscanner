...
public class MainActivity_photo extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
    private static final String TAG = "moubiao";
    public static MainActivity_photo instance;
...
//                                    mCamera.startPreview();
    ...
    private void initView() {
        ...
        mHolder.addCallback(MainActivity_photo.this);
