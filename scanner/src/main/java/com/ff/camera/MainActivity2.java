...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
    ...
    private void initView() {
        ...
        mHolder.addCallback(MainActivity2.this);
...
//            mCamera.cancelAutoFocus();//聚焦
    ...
    public void startTimmer() {
        picHandler.sendEmptyMessageDelayed(1, 2000);
    }
